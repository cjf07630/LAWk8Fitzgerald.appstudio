...
const cacheName = 'LAWk8Fitzgerald-2021-03-29 15:45:20.447034'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LAWk8Fitzgerald'.length) === 'LAWk8Fitzgerald') {
